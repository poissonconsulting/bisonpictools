...
function to visualize ratios in the classified counts from the camera
...
function runs the analysis. The following example uses the built-in
example data in the demonstrative “quick” analysis mode.
...
function to view the model estimates.
