...
knitr::include_graphics("figures/app-overview.png")
```
...
```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("figures/shinybisonpic-data-upload.png")
```
...
```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("figures/shinybisonpic-data-upload-failure.png")
```
...
```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("figures/shinybisonpic-data-upload-successful.png")
```
...
```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("figures/shinybisonpic-map-locations-point.png")
```
...
The numerator:(denominator + numerator) ratio is plotted instead of the typical numerator:denominator ratio because it is possible to choose groups that have a ratio of one positive integer to zero, which equals infinity, and is not easily displayed graphically.
...
Always restart your R after installing a new package.
...
Also you can use the packages update button in RStudio to update the package. 

2. There are two different ways the app can be launched:

   - Run code that launches the script
...
```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("figures/runbisonpic-addins-button.png")
```   
...
```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("figures/runbisonpic-data-upload-tab.png")
```
...
```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("figures/runbisonpic-data-upload-failure.png")
```
...
```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("figures/runbisonpic-data-upload-successful.png")
```
...
```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("figures/runbisonpic-model-tab.png")
```
...
```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("figures/runbisonpic-model-spinner.png")
```
...
```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("figures/runbisonpic-successful-model.png")
```
...
```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("figures/runbisonpic-results.png")
```
